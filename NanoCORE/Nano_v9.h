...
#define NLHESCALEWEIGHT_MAX 9 // for LHEScaleWeight_* collection
...
protected:
    ...
    float eft_weight_;
    TBranch *b_eft_weight_;
    bool loaded_eft_weight_;
...
namespace tas {
    ...
    const float &eft_weight(); // generator weight
